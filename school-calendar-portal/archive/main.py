...
os.chdir(BASE_DIR)  # ensure git commands run in the correct repo
DATA_DIR = os.path.join(BASE_DIR, "data")
PROCESSED_DIR = os.path.join(DATA_DIR, "processed")
OUTPUT_DIR = os.path.join(BASE_DIR, "output")
os.makedirs(OUTPUT_DIR, exist_ok=True)

# HTML output goes to ROOT (GitHub Pages deploys from repo root)
...
builder.build(ROOT_HTML)
print(f"[main] Generated HTML -> {ROOT_HTML}")
print(f"Done! Open: {ROOT_HTML}")
