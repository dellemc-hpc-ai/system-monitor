import shutil, os, sys, json, hashlib

# Clear pycache
for root, dirs, files in os.walk('C:/Users/frank/.openclaw/workspace/projects/TASK-001-allergy-report/school-calendar-portal'):
    for d in dirs:
        if d == '__pycache__':
