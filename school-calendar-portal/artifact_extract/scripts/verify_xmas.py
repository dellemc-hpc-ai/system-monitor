...
for d in [date(2025,12,15), date(2025,12,16), date(2025,12,17), date(2025,12,18), date(2025,12,19), date(2025,12,20)]:
...
for d in [date(2026,12,15), date(2026,12,16), date(2026,12,17), date(2026,12,18), date(2026,12,19), date(2026,12,20)]:
    idx = bisect.bisect_right(starts, d) - 1
    if idx >= 0:
        iv = ivs[idx]
        s, e = date.fromisoformat(iv['start']), date.fromisoformat(iv['end'])
