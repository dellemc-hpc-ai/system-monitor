...
for yr in data.get('schoolYears', []):
    if yr.get('year') == '2026-2027':
        ...
        sys.stdout.buffer.write(f"2026-2027 noschool_days count: {len(days)}\n".encode('utf-8'))
        for d in days:
...
for iv in ivs._intervals:
    if iv.start.isoformat() in ['2026-10-08','2026-10-09','2026-10-10','2026-10-11','2026-10-12','2026-10-13']:
        sys.stdout.buffer.write(f"{iv.start.isoformat()}: {iv.custodian} ({iv.reason})\n".encode('utf-8'))
